...
const YesIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if(estadoPartida === 0){
            speakOutput = `Durante este juego tendrás que usar algunos objetos y tomar decisiones que afectarán el rumbo de la historia... Comienza el juego <audio src="soundbank://soundlibrary/radios_static/radios_static_06"/>
            <voice name="Lupe"> <amazon:domain name="news"> La hija de Isao Okada, el dueño de la fábrica más grande de nuestra ciudad, ha desaparecido este 9 de abril. Su nombre es Hana Okada, lo último que se sabe de ella es que iba en camino a su casa después de la escuela, pero nunca llegó. Se rastreó su celular y su más reciente localización indica que estaba en el bosque Kokura... </amazon:domain> </voice> <audio src="soundbank://soundlibrary/radios_static/radios_static_06"/>
            ...
            Al llegar bajas de tu auto junto a Scraps e inspeccionas tu cajuela; tienes una mochila pero ésta sólo tiene espacio para 3 objetos. Los objetos son: linterna, batería portatil, botiquín, cinta métrica, cámara instantánea, grabadora y rompe candados en mal estado.
